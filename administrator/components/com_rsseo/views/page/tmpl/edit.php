	...
	<div class="<?php echo RSSeoAdapterGrid::row(); ?>">
		<div class="<?php echo RSSeoAdapterGrid::column(6); ?>">
			...
			<fieldset class="options-form">
				...
				<button type="button" class="btn btn-info button" onclick="RSSeo.addCustomMetadata()"><?php echo Text::_('COM_RSSEO_ADD_NEW'); ?></button>
				<table class="table table-striped" id="metaDraggable">
					<thead>
						<tr>
							<th><?php echo Text::_('COM_RSSEO_METADATA_TYPE'); ?></th>
							<th><?php echo Text::_('COM_RSSEO_METADATA_NAME'); ?></th>
							<th align="right"><?php echo Text::_('COM_RSSEO_METADATA_CONTENT'); ?></th>
							<th width="1%"></th>
						</tr>
					</thead>
					<tbody id="customMeta">
					...
					<tr id="meta00<?php echo $i; ?>">
						...
						<td><a href="javascript:void(0)" class="btn btn-danger" onclick="RSSeo.removeCustomMetadata('00<?php echo $i; ?>');"><?php echo Text::_('COM_RSSEO_DELETE');?></a></td>
					</tr>
					<?php $i++; ?>
					<?php } ?>
					<?php } ?>
			...
			<fieldset class="options-form">
				...
				<button id="brokenButton" type="button" class="btn btn-info button" onclick="RSSeo.broken('<?php echo addslashes(Uri::root().$this->item->url); ?>', <?php echo $this->item->id; ?>)">
				<?php } else { ?>
