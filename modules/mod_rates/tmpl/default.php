...
<div style="text-align:center; class="custom">
<h1>Kurs wymiany i konwerter walutowy <? echo $strCurrency1FullTitle1;?> (<? echo $strCurrency1;?>)</h1>
...
<span class="h11"> <h3><?php echo JText::_('EXCHANGE_RATE'); ?> </h3></span>
 ...
 <span class="h13">	1 <span class="currency1full"><?php echo $strCurrency1FullTitle; ?></span> (<span class="currency1"><?php echo $strCurrency1; ?></span>) = <span class='table-rates' direction='12' amount='1'><?php echo number_format($rate1, 2, '.', ''); ?></span> <span class="currency2full1"><?php echo $strCurrency2FullTitle1; ?></span> (<span class="currency2"><?php echo $strCurrency2; ?></span>)</span> <div> <span class="lastupdatedate"><?php echo JText::_('ACTUAL_EXCHANGE_RATE_FROM') ?>: <? echo $strLastUpdateDate; ?></span>  </div>
  ...
  <p style="text-align:center;"> <h4> Tabela kursów do wydruku</h4></p>	
	<table id="table-rates" style="width:99%;margin-left=10%;">
	
  	<tr>
			<th colspan="3" style="text-align: center;"><span class="currency1full"><?php echo $strCurrency1FullTitle; ?></span> - <span class="currency2full"><?php echo $strCurrency2FullTitle; ?></span></th>
			<th> </th>
			<th colspan="3" style="text-align: center;"><span class="currency2full"><?php echo $strCurrency2FullTitle; ?></span> - <span class="currency1full"><?php echo $strCurrency1FullTitle; ?></span></th>
		</tr>
	<?php  
  
  
  
      if ($strCurrency1=="BYR" || $strCurrency1=="RUB" || $strCurrency1=="VND") {
    	$arrAmounts = array(10,50,100,500,1000,5000,10000);  
      } 
      
     else
      {     
      
		$arrAmounts = array(1,5,10,50,100,500,1000); }
	
  
  
  	foreach ($arrAmounts as $intAmount) {
        $formatedamt1 =number_format($intAmount*$rate1, 2, '.', '');
        if($formatedamt1==0 && !$showZeroValues){
         continue;
			...
			echo "
				...
				<tr>
					<td style='text-align: center;'>$intAmount <span class='currency1'>$strCurrency1</span></td>
					<td style='text-align: center;'>=</td>
					<td style='text-align: center;'><span class='table-rates' direction='12' amount='$intAmount'>".$formatedamt1."</span> <span class='currency2'>$strCurrency2</span></td>
					<td width='20'></td>
          
					<td style='text-align: center;'>$intAmount <span class='currency2'>$strCurrency2</span></td>
					<td style='text-align: center;'>=</td>
					<td style='text-align: center;'><span class='table-rates' direction='21' amount='$intAmount'>".number_format($intAmount*$rate2, 2, '.', '')."</span> <span class='currency1'>$strCurrency1</span></td>
				</tr>
			"; 
		}   
	?>
...
<br />
<span style="background-color: #5B74A8; display: inline-block; padding: 4px; font-family: 'arial','Lucida Sans Unicode','Lucida Grande',Sans-Serif; font-weight: bold; color: white; border-width: 1px; border-style:solid; cursor: pointer; border-color: #29447E #29447E #1A356E;" onclick="printIt();"><?php echo JText::_('PRINT'); ?></span> <br /><br />
<? 
$waluta = $params->get("cid1");
$waluta1 = JText::_("CURRENCY_" . strtoupper($waluta)."1");
  
 ?>

<p>

<?php echo JText::_("OPISA") ?>
                                    
 <br />
 <?php echo JText::_("OPISB") ?> <?php echo $waluta1;  ?> (<?php echo $strCurrency1;  ?>) <?php echo JText::_("OPISC") ?> <br />
</p>
<br>
