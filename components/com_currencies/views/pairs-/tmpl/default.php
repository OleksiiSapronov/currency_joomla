...
$pairtitle = sprintf(JText::_('CURRENCIES_12A'), $all->format($this->value), JText::_('MAIN_' . strtoupper($this->base->name)), $this->base->code, $this->currency2->code, number_format($this->current[1] * $this->value, 2, $com1, $com2), $msc, $funt);
...
echo sprintf(JText::_('CURRENCIES_16'), number_format(($this->value), $decimaly, $com1, $com2), $this->base->code, $this->currency2->code, JText::_('MAIN_' . strtoupper($this->base->name)), $normalvalue1, $funt1, $this->currency2->name, JText::_('MAIN_' . strtoupper($this->currency2->name)), $link3, '<strong>', '</strong>', $link4, '<br>',JText::_('MAINMC_' . strtoupper($this->base->name)),$linkcal);
    ...
    <?php
  if ($this->base->code=="BTC") {$this->range  = array(1, 2, 3,5, 10,15,25,50,100,200,500,1000,2000,5000);}
  else {$this->range  = array(1, 2, 5, 10,25,50,100,200,500,1000,2000,5000,10000,20000);}
 if ($this->base->code=="BTC") {  $this->range2 = array(50,100, 200, 500, 1000,2000, 5000, 10000,20000, 50000, 100000,200000, 500000, 1000000);}
else {  $this->range2 = array(1, 2, 5, 10,25,50,100,200,500,1000,2000,5000,10000,20000);}

    $os1 = array("VND", "IDR", "GNF", "KHR", "IRR", "PYG", "BYR", "COP", "UZS", "MGA", "UGX", "LAK", "xxx");
    if (in_array($this->base->code, $os1))
    {
     $this->range = array(5000, 10000,20000, 50000, 100000,20000, 500000, 1000000, 5000000, 10000000, 20000000, 50000000, 100000000,200000000);
    }
    $os2 = array("VND", "IDR", "GNF", "KHR", "IRR", "PYG", "BYR", "COP", "UZS", "MGA", "UGX", "LAK", "xxx");

    if (in_array($this->currency2->code, $os2))
    {
     $this->range2 = array(5000, 10000,20000, 50000, 100000,20000, 500000, 1000000, 5000000, 10000000, 20000000, 50000000, 100000000,200000000);
    }

    $os3 = array("", "XOF", "LBP", "KMF", "CRC", "LBP", "BIF", "TZS", "RWF", "IQD", "MMK", "SYP", "CLP", "KRW", "AMD");
    if (in_array($this->base->code, $os3))
    {
     $this->range = array(500, 1000, 2000, 5000, 10000, 20000, 50000, 100000, 200000, 500000, 1000000, 2000000, 5000000, 10000000);
    }

    $os4 = array("", "XOF", "LBP", "KMF", "CRC", "LBP", "BIF", "TZS", "RWF", "IQD", "MMK", "SYP", "CLP", "KRW", "AMD");
    if (in_array($this->currency2->code, $os4))
    {
     $this->range2 = array(500, 1000, 2000, 5000, 10000, 20000, 50000, 100000, 200000, 500000, 1000000, 2000000, 5000000, 10000000);
    }
    ...
    {
     $this->range = array(50,100, 200, 500, 1000, 2000, 5000, 10000,25000, 50000, 100000, 200000,500000,1000000);
    }
    ...
    {
     $this->range2 = array(50,100, 200, 500, 1000, 2000, 5000, 10000,25000, 50000, 100000, 200000,500000,1000000);
    }
    ...
    {
     $this->range = array(5,10, 20, 50, 100, 200, 500, 1000,2000, 5000, 10000, 20000, 50000, 100000);
    }
    ...
    {
     $this->range2 = array(5,10, 20, 50, 100, 200, 500, 1000,2000, 5000, 10000, 20000, 50000, 100000);
    }
    ?>
...
<?php echo sprintf(JText::_('COM_CURRENCIES_CONVERSION_FORM'), $this->base->code, $this->currency2->code) ?></h3>
        ...
        <?php ?>
                 ...
                 <table class="table table-striped table-bordered">
                                    <th class="range2">  <?php echo JText::_('COM_CURRENCIES_PAIRING')." ". $this->base->code . " " ?>
...
<?php echo $decimalf ?> 
  ...
  <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->currency2->code . '&to=' . $this->base->code . '&value=10&Itemid=' . $this->params->get('pairs_itemid')); ?>"> <?php echo $this->currency2->code ?> </a>
  ...
  <th class="range2"> <?php echo JText::_('COM_CURRENCIES_CONVERT_T')." ".$this->currency2->code ?>
...
<?php echo decima0($range2) ." " .$funt . " (" . $this->currency2->code .") " ?> 
             ...
             <?php echo $decimalf2 ?> <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&to=' . $this->currency2->code . '&value=1&Itemid=' . $this->params->get('pairs_itemid')); ?>"><?php echo " ". $this->base->code ?>  </a>
      ...
      <?php if (count($this->rates) > 0) { ?>
                            ...
                            <tr>
                                ...
                                <th> <?php echo JText::_('COM_CURRENCIES_PAIRING')." ".$funt1 ?> = <?php echo $funt ?></th>
                            </tr>
       <?php $count = 0; ?>
...
if (($rate->rate * $this->value) < 10)
  ...
  <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&to=' . $this->currency2->code . '&value=' . ceil($this->value) . '&Itemid=' . $this->params->get('pairs_itemid')); ?>">
           ...
           <?php echo $decimalf3 ?>  <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->currency2->code . '&to=' . $this->base->code . '&value=25&Itemid=' . $this->params->get('pairs_itemid')); ?>"><?php echo " ". $this->currency2->code ?></a>
 ...
 <h4 class="h4dol"><?php echo  JText::_('COM_CURRENCIES_CONVERT_T')." ". number_format($this->value, countDecimals($this->value)) . ' ' . $this->base->code . ' ' . JText::_('COM_CURRENCIES_EXCHANGE_IN_OTHER_CURRENCY') ?></h4>
...
{ $funt2 = "Pound"; } else { $funt2 = end($contents1); }        
        ...
        ?>
                                ...
                                <tr>
                                    <td>
<a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&to=' . $currencyvalue->code . '&value='.ceil($this->value).'&Itemid=' . $this->params->get('pairs_itemid')); ?>">
