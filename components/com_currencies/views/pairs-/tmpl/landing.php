...
<div class="currenciesc container-fluid">
    ...
    <?php if ($detect->isTablet() && $i > 7) {
                 ...
                 " title="<?php echo $currency->name ?>">
                    <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->params->get('primary_currency') . '&to=' . $currency->code . '&value=1&Itemid=' . $this->params->get('pairs_itemid')); ?>">
...
<?php echo sprintf(JText::_('CURRENCIES_5'),JText::_('MAIN_'.strtoupper($this->base->name)),"<strong>","</strong>",$this->base->name); ?>
   ...
   <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $hrate->currency2 . '&layout=landing&Itemid=' . $this->params->get('pairs_itemid')) ?>"><?php echo  JText::_(JText::_('MAIN_' . strtoupper($hrate->currency_name))) . ' (' . $hrate->currency2 . ')' ?></a>
                            ...
                            <td class="currencyex">
								...
								<?php echo '1 ' ?> <a
                                        href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&layout=landing&Itemid=' . $this->params->get('pairs_itemid')) ?>">
									<?php
								...
								<?php //number_format($hrate->rate,$decimal,$com1,$com2)  ?>
                            ...
                            <td class="pairingex">
                                <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&to=' . $hrate->currency2 . '&value=' . $this->defaultValue) ?>"> <?php echo JText::_('COM_CURRENCIES_CONVERT_T')." " . $this->base->code ." ". JText::_('COM_CURRENCIES_ON_THIS_TO'). " " . $hrate->currency2 ?></a>
                            </td>
