...
<?php echo Juri::root() . 'images/flags/' . $top_currency->flag ?>">
	...
	<!-- end converter -->
 <br/>{module Reklama big banner BOTTOM}    
	<br/>
...
?>
                            ...
                            <td class="pairingex">
                                <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&base=' . $this->base->code . '&to=' . $hrate->currency2 . '&value=' . $this->defaultValue) ?>"> <?php echo JText::_('COM_CURRENCIES_CONVERT_T') . " " . $this->base->code . '/' . $hrate->currency2 ?></a>
                            </td>

                            <td class="hidden-sm hidden-xs">
                                <a href="<?php echo JRoute::_('index.php?option=com_currencies&view=pairs&layout=calculator&base=' . $hrate->currency2) ?>"><?php echo JText::_('COM_CURRENCIES_CALCULATOR')." ".$hrate->currency2 ?></a>
                            </td>
