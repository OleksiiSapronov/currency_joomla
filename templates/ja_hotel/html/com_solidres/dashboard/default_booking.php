...
<div class="navbar dashboard-nav">
	<div class="navbar-inner">
			...
			<a class="btn btn-navbar hidden-md hidden-lg" data-toggle="collapse" data-target=".nav-collapse-stats">
				<i class="fa fa-bars"></i>
			</a>
			<!-- Be sure to leave the brand out there if you want it shown -->
			<!--<a class="brand" href="#">Project name</a>-->
			<!-- Everything you want hidden at 940px or less, place within here -->
			<div class="nav-collapse nav-collapse-stats collapse">
						...
						<li>
							...
							<div class="date-toggle">
								<div class="date-customtab">
									...
									<select id="CB" class="compare" data-compare-type="booking">
										<option value="Se">Please select</option>
										<option value="Pre">Previous period</option>
										<option value="Cus">Custom</option>
									</select>

									<input id="inCBFrom" class="disabledInputFrom" type="text"  readonly="true" placeholder=<?php echo JText::_('SR_STATISTICS_FROM')?> >
									<input id="inCBTo" class="disabledInputTo" type="text"  readonly="true" placeholder=<?php echo  JText::_('SR_STATISTICS_TO')?> >
