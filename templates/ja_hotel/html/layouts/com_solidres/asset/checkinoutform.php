...
<div class="form-inline">
    <div class="form-group">
        ...
        <div class="checkin_datepicker_inline datepicker_inline" style="display: none; position:absolute; z-index:10000"></div>
    ...
    <div class="form-group">
        ...
        <div class="checkout_datepicker_inline datepicker_inline" style="display: none; position:absolute; z-index:10000"></div>
        <?php // this field must always be "Y-m-d" as it is used internally only ?>
