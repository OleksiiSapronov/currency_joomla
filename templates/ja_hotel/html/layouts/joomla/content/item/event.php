				...
				<?php if($item->params->get('ctm_latitude') && $item->params->get('ctm_longitude')): ?>
					...
					<script type="text/javascript">
						...
						function initialize() {
							var mapOptions = {
								zoom: 15,
								center: new google.maps.LatLng(<?php echo (float) $item->params->get('ctm_latitude'); ?>, <?php echo (float) $item->params->get('ctm_longitude'); ?>)
							};
							map = new google.maps.Map(document.getElementById('ja-event-map'),
								mapOptions);
						}
