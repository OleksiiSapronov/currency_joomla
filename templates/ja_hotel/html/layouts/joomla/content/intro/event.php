...
<div class="magazine-item-main">
	...
	<div class="event-info">
  	<ul>
  		<li>
			<i class="fa fa-calendar-o"></i><?php echo JHtml::_('date', $item->params->get('ctm_start',''), 'DATE_FORMAT_LC3'); ?>
			-
			<?php echo JHtml::_('date', $item->params->get('ctm_end',''), 'DATE_FORMAT_LC3'); ?>
		</li>
  		<li><i class="fa fa-building"></i><?php echo $item->params->get('ctm_venue',''); ?></li>
  		<li><i class="fa fa-location-arrow"></i><?php echo $item->params->get('ctm_addr1',''); ?></li>
  	</ul>
  </div>
