		...
		$(document).ready(function(){
			JAVideoPlayer.playlist = function() {
				$('.ja-video-list').each(function(){
					...
					if(container.find('.video-title').length) {
						btnPlay = container.find('.video-title');
					}
...
<h3 class="item-image ja-video-list" data-url="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($item->id, $item->catid)); ?>"
