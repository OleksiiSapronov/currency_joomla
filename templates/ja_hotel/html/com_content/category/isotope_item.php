...
<?php endif; ?>
	...
	<article>
      ...
      <aside class="article-aside clearfix">
        <?php if ($topInfo): ?>
        <?php echo JLayoutHelper::render('joomla.content.info_block.nonecateogry_block', array('item' => $this->item, 'params' => $params, 'position' => 'above')); ?>
        <?php endif; ?>
      </aside>  
      <?php endif; ?>
      <!-- //Aside -->
      ...
      <?php endif; ?>
		...
		<?php if (($icons) || ($params->get('show_tags', 1) && !empty($this->item->tags)) || ($params->get('show_readmore') && $this->item->readmore) ) : ?>
