...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<div class="userAdditionalInfo">
			...
			<span class="userURL">
				<a href="<?php echo $this->user->profile->url; ?>" target="_blank" rel="me"><i class="fa fa-globe"></i> <?php echo $this->user->profile->url; ?></a>
			</span>
			<?php endif; ?>
			  ...
			  <div class="item-meta">
				<div class="boxk2">
					...
					<span class="userItemDateCreated">
						<?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC4')); ?>
					</span>
					<?php endif; ?>
				</div>
				<div class="boxk2">
