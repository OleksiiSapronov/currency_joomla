		...
		<ul>
			...
			<li>
				...
				<a href="#" id="fontDecrease">
					...
					<img src="<?php echo JURI::root(true); ?>/templates/<?php echo JFactory::getApplication()->getTemplate() ?>/images/system/font_decrease.gif" alt="<?php echo JText::_('K2_DECREASE_FONT_SIZE'); ?>" />
				</a>
				<a href="#" id="fontIncrease">
					<span><?php echo JText::_('K2_INCREASE_FONT_SIZE'); ?></span>
					<img src="<?php echo JURI::root(true); ?>/templates/<?php echo JFactory::getApplication()->getTemplate() ?>/images/system/font_increase.gif" alt="<?php echo JText::_('K2_INCREASE_FONT_SIZE'); ?>" />
				</a>
			</li>
			<?php endif; ?>
	  ...
	  <div class="item-meta">
		...
		<div class="boxk2">
			...
			<span class="hidden-xs hidden-sm itemDateCreated">
				<?php echo JText::_('K2_DATE_CREATED') ; ?>
			</span>
			<span class="itemDateCreated">
				<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC4')); ?>
			</span>
			<?php endif; ?>
		</div>
