...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <span class="moduleItemDateCreated"><i class="fa fa-clock-o"></i><?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC4')); ?></span>
      <?php endif; ?>

      <?php if($params->get('itemCategory')): ?>
      <a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><i class="fa fa-folder-o"></i> <?php echo $item->categoryname; ?></a>
      <?php endif; ?>
