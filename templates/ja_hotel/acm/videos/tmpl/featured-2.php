...
<div class="videos-featured videos-featured-2">

	<div class="col videos-featured-items">

    <div class="player-wrap col-md-12 col-lg-8">
    ...
    <?php if ($show_leading_title) : ?>
      ...
      $aparams->set('show_create_date', 0);
			?>
			<div class="videos-featured-list col-md-12 col-lg-4 <?php if($count_leading > 5) echo 'has-scroll'?>">
				<ul>
					<?php
					$i = 0;
